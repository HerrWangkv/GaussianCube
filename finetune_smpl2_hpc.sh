...
mpiexec -n 4 python finetune_smpl2.py \
    --exp_name ./output/gaussiancube_finetuning_smpl2_ema13 \
    ...
    --use_fp16 \
    --use_tensorboard \
    --resume_checkpoint output/gaussiancube_finetuning_smpl2_ema12/checkpoints/step_017000/lora_model017000.pt
