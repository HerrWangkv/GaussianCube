...
mpiexec -n 4 python finetune_smpl2.py \
    --exp_name ./output/gaussiancube_finetuning_smpl2_ema10 \
    ...
    --use_fp16 \
    --use_tensorboard \
    --resume_checkpoint output/gaussiancube_finetuning_smpl2_ema2/checkpoints/step_009000/lora_model009000.pt
