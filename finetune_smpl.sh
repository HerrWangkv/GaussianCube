...
mpiexec -n 4 python finetune_smpl.py \
    --exp_name ./output/finetune_smpl_0924_1750 \
    ...
    --use_fp16 \
    --use_tensorboard \
    --resume_checkpoint output/finetune_smpl_0924_1050/checkpoints/step_007000/lora_model007000.pt \

echo "LoRA fine-tuning completed!"
echo "Check results in: ./output/finetune_smpl_0924_1750/"